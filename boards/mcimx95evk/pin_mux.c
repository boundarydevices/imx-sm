...
void BOARD_InitPins(void)
{
    ...
    /* Configure GPIO5-7 (INT from the PF09) */
    IOMUXC_SetPinMux(IOMUXC_PAD_XSPI1_DATA7__GPIO5_IO_BIT7, 0U);
    IOMUXC_SetPinConfig(IOMUXC_PAD_XSPI1_DATA7__GPIO5_IO_BIT7, 0U);
}
